package com.example.changzhenjie.mynote.paymentbalance;
...
public class PaymentsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = UiUtils.getView(this,R.id.viewpager_container);
        tabLayout = UiUtils.getView(this,R.id.paments_tablayout);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.payments_fragment_main, container, false);
